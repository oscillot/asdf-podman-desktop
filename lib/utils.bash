...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for podman-desktop.
GH_REPO="https://github.com/oscillot/asdf-podman-desktop"
...
install_version() {
	...
	(
		...
		# TODO: Assert podman-desktop executable exists.
		local tool_cmd
